...
class SearchService implements IService {
	...
	public constructor(private context: IBusiness = $inject("business/searchBusiness"), private flag: boolean = false) {}
	...
	public retrieve(userAgent: string, line?: string): any {
		return (line!==undefined)? this.context.retrieve(userAgent, this.processData(line), this.flag) : this.context.retrieve(userAgent);
	}
